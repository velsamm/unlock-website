      ...
      <div className="grid grid-cols-2 grid-rows-5 gap-10">
        ...
        <div className="md:col-span-1 row-span-1 col-span-2 flex">
          <Typography className="my-auto" appearance="header">
            Разблокируем доступ к средствам на криптовалютных биржах и
            банковских счетах
          </Typography>
        </div>
        ...
        <div className="md:col-span-1 row-span-1 col-span-2 flex">
          <Typography className="my-auto">
            Профессиональная юридическая помощь при блокировке криптовалютных и
            банковских счетов
          </Typography>
        </div>

        <div className="md:col-span-1 row-span-1 col-span-2 flex">
          <a href="/#contact-options">
            <Button className="my-auto w-full md:w-auto">
              <Typography appearance="button">Получить консультацию</Typography>
            </Button>
          </a>
        </div>
