import starPic from 'src/assets/icons/svg/star.svg'
import star2Pic from 'src/assets/icons/svg/star-2.svg'
            ...
            <div className="row how-we-work-container">
                <div className="col how-we-work-item">
                    <div className="row column relative">
                        <div className="star">
                            <img src={String(starPic)} alt="starPic" />
                        </div>
                ...
                <div className="col how-we-work-item">
                    <div className="row column relative">
                        <div className="star-2">
                            <img src={String(star2Pic)} alt="star2Pic" />
                        </div>
                        <div className="header">
